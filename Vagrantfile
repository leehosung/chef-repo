...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "leclipse-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/leehosung"
  #   chef.validation_client_name = "leehosung-validator"
  #   chef.validation_key_path = ".chef/leehosung-validator.pem"
  # end
end
